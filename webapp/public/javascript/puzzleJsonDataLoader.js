var questionsAnswersDataMap;

var fillQuestionAnswerDataMap = function () {

	questionsAnswersDataMap = new Object();

	var jsonPuzzleArray = fillAndReturnInterviewPuzzles();

	questionsAnswersDataMap['interviewPuzzles'] = jsonPuzzleArray;

};

var getFilledMapWithGivenKey = function (key) {
	return questionsAnswersDataMap[key];
};

exports.fillQuestionAnswerDataMap = fillQuestionAnswerDataMap;
exports.getFilledMapWithGivenKey = getFilledMapWithGivenKey;
...
function fillAndReturnInterviewPuzzles() {
	...
	var jsonPuzzleArray = [
		...
		{
			"puzzleURL": "rickety-bridge-problem",
